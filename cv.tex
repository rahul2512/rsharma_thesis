...
\centering{\huge \textbf{Rahul Sharma}}\\
\vskip .1cm
\centering{C502, Allée des Cèdres 16, Chavannes-près-Renens, 1022} \\
\centering{Email: rahul.sharma@epfl.ch, Mobile:~+41-779-369-486, \href{https://github.com/rahul2512}{Github: ~github.com/rahul2512}} \\
\centering{  \href{https://orcid.org/0000-0003-0700-3098}{ORCID ID}, \href{https://scholar.google.co.in/citations?user=OPxzxGwAAAAJ&hl=en}{Google Scholar} }\\
\vskip .6cm
\urlstyle{rm}
...
\section{~~Education}
\begin{itemize}
    \item[] \textbf{École Polytechnique Fédérale de Lausanne} 
\end{itemize}
